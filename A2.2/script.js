...
slider2 = createSlider(0,255,40);
 slider2.parent('column-one');
  ...
  let p6 = createP('Text Level 1');
  p6.parent('column-one')
  inp1 = createInput('Your Title 1');
  let p3 = createP('Text Level 2')
  inp2 = createInput('Your Title 2');
  ...
  p5.parent('column-one');
    ...
    sel.option('Stonks', '/images/20210922_atw_memeStonk_800x800.png');
  sel.option('Xavier', '/images/xavier-pakalupapito-meme.jpg');
  sel.option('Brain', '/images/brain meme.jpg');
 ...
 p9.parent('column-one');
    ...
    p8.class('text');
    p9.class('text');
  function imageUpdate(){let m1 = sel.value();
  im1 = loadImage(m1);}
   function saveimg(){
     saveCanvas(cnv,'my meme','png')
   }
  }
